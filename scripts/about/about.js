    ...
    contentTarget.innerHTML = `
      <div id="about__modal" class="modal--parent">
        <div id="about__content" class="modal--content">
          <section>Welcome to the best way to purchase baked goods!! There has definitely never been an app like this!!! Create an account and become a rewards member for a good time!!!!</section>
          <section><a target="_blank" href="https://github.com/nss-day-cohort-46/sprinkles-of-joy-admiral-ackbar-pudding">GitHub</a></section>
          <section>&copy; Phillip Phan and Caleb James</section>
